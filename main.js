...
var numeroaleatorio = Math.floor(Math.random()* quickDrawDataset.length + 1)
var sketch = quickDrawDataset[numeroaleatorio] 
var timerCounter  = 0
var timerCheack = '' 
var drawsketch = ''
var anserwHolder = ''
...
function draw(){
  ...
  function cheack (){
    ...
    timerCheack = 'completo'
 timerCounter = 0 
    }
    if (timerCheack == 'completo'|| anserwHolder == 'set'){
   timerCheack = ''
   anserwHolder = ''
   updatecanvas()
    }
...
function gotresult(error , result ){
  ...
  console.log(result)
  var resultado = result[0].label.replace('_' , ' ')
  document.getElementById('nome').innerHTML = resultado
  var precisao = result[0].confidence
  document.getElementById('precisao').innerHTML = Math.round(precisao*100) + '%'
  }
